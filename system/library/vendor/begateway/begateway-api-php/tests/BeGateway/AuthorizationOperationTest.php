...
class AuthorizationOperationTest extends AbstractTestCase
{
    ...
    public function testEndpoint(): void
    {
        ...
        $this->assertEquals($url, Settings::$gatewayBase . '/transactions/authorizations');
    }
    ...
    public function testSuccessAuthorization(): void
    {
        ...
        $this->assertEquals($cents, $arResponse['transaction']['amount']);
    }

    public function testIncompleteAuthorization(): void
    {
    ...
    public function testFailedAuthorization(): void
    {
        ...
        $this->assertEquals('Authorization was declined', $response->getMessage());
        $this->assertNotNull($response->getUid());
    ...
    public function testErrorAuthorization(): void
    {
        $auth = $this->getTestObject();
        ...
        $this->assertMatchesRegularExpression('/Date is expired/i', $response->getMessage());
    ...
    private function getTestObjectInstance(bool $threeds = false): AuthorizationOperation
    {
