...
class VoidOperationTest extends AbstractTestCase
{
    ...
    public function testEndpoint(): void
    {
        ...
        $this->assertEquals($url, Settings::$gatewayBase . '/transactions/voids');
    }
    ...
    public function testErrorVoidRequest(): void
    {
        $amount = rand(0, 10000);
    ...
    private function getTestObject(): VoidOperation
    {
        $transaction = $this->getTestObjectInstance();
    ...
    private function getTestObjectInstance(): VoidOperation
    {
        self::authorizeFromEnv();
